...
public class PolygonBuilder extends GeoShapeBuilder {
    
    public static final String TYPE = "polygon";

    private final ILineStringBuilder shell;
    private final ArrayList<LineStringBuilder> holes = new ArrayList<LineStringBuilder>();
    ...
    protected PolygonBuilder(ArrayList<Coordinate> points) {
        this.shell = new ILineStringBuilder(points);
    }
    ...
    public ILineStringBuilder hole() {
        ILineStringBuilder hole = new ILineStringBuilder();
        this.holes.add(hole);
        return hole;
    }
    ...
    protected Polygon asIs(GeometryFactory factory) {
    ...
    public class ILineStringBuilder extends LineStringBuilder {

        protected ILineStringBuilder() {
            super();
        }
        
        protected ILineStringBuilder(ArrayList<Coordinate> points) {
            super(points);
        }
