...
public class CompletionFieldMapper extends AbstractFieldMapper<String> {
    ...
    public static class Builder extends AbstractFieldMapper.Builder<Builder, CompletionFieldMapper> {
        ...
        public Builder context(CompletionContext context) {
        ...
        public CompletionFieldMapper build(Mapper.BuilderContext context) {
            return new CompletionFieldMapper(buildNames(context), indexAnalyzer, searchAnalyzer, postingsProvider, similarity, payloads,
                    preserveSeparators, preservePositionIncrements, maxInputLength, this.context);
        }
        ...
        public Mapper.Builder<?, ?> parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException {
            ...
            for (Map.Entry<String, Object> entry : node.entrySet()) {
                ...
                if (fieldName.equals("analyzer")) {
                    ...
                    Map<String, Object> config = (Map<String, Object>)fieldNode; 
                    builder.context(CompletionContext.build(config));
                } else {
    ...
    public CompletionFieldMapper(Names names, NamedAnalyzer indexAnalyzer, NamedAnalyzer searchAnalyzer, PostingsFormatProvider postingsProvider, SimilarityProvider similarity, boolean payloads,
                                 boolean preserveSeparators, boolean preservePositionIncrements, int maxInputLength, CompletionContext context) {
    ...
    /**
     * Does this completion field require context information for suggestions  
     * @return true if context requires to be configured
     */
    ...
    public void parse(ParseContext context) throws IOException {
        ...
        CompletionContext.Builder contextBuilder = null;
            ...
            while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                if (token == XContentParser.Token.FIELD_NAME) {
                    ...
                    if(this.context != null) {
                        throw new ElasticSearchIllegalArgumentException(Fields.CONTEXT + " has been defined already");
                    } else {
                        contextBuilder = this.context.parseContext(parser);
                    }
        ...
        if (surfaceForm == null) { // no surface form use the input
            for (String input : inputs) {
                ...
                context.doc().add(getCompletionField(contextBuilder, input, suggestPayload));
            }
        } else {
            BytesRef suggestPayload = analyzingSuggestLookupProvider.buildPayload(new BytesRef(
    ...
    public Field getCompletionField(CompletionContext.Builder context, String input, BytesRef payload) {
        ...
        return new SuggestField(names.indexName(), context, input, this.fieldType, payload, analyzingSuggestLookupProvider);
    }
    ...
    private static final class SuggestField extends Field {
        ...
        private final CompletionContext.Builder context;
        
        public SuggestField(String name, CompletionContext.Builder context, Reader value, FieldType type, BytesRef payload, CompletionTokenStream.ToFiniteStrings toFiniteStrings) {
        ...
        public SuggestField(String name, CompletionContext.Builder context,String value, FieldType type, BytesRef payload, CompletionTokenStream.ToFiniteStrings toFiniteStrings) {
            super(name, value, type);
            this.payload = payload;
            this.toFiniteStrings = toFiniteStrings;
            this.context = context;
