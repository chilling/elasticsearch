...
public class PrefixAnalyzer extends Analyzer {
     ...
     */
    public PrefixAnalyzer(Analyzer analyzer, CharSequence prefix) {
        this(analyzer, Collections.singleton(prefix));
    }
     ...
     */
    public PrefixAnalyzer(Analyzer analyzer, Iterable<? extends CharSequence> prefix) {
        super();
    ...
    protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
        ...
        TokenStream stream = new PrefixTokenFilter(createComponents.getTokenStream(), prefix);
    ...
    public static final class PrefixTokenFilter extends TokenFilter {
         ...
         * @param prefix {@link Iterable} of {@link CharSequence} which keeps all prefixes 
         */
        public PrefixTokenFilter(TokenStream input, Iterable<? extends CharSequence> prefixes) {
            super(input);
        ...
        public boolean incrementToken() throws IOException {
            ...
            termAttr.append(DEFAULT_SEPARATOR);
